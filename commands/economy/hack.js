...
$interactionReply[;{newEmbed:{description:**๑ ⋆˚₊⋆────ʚ forking code success ɞ────⋆˚₊⋆ ๑
    ...
    ・ —  — ・ˏ͛- <:hacker_ita:920683462229360661> ˎˊ˗・ —  —・**}{color:dabeff}};{actionRow:{button:$random[10;950] datas transfered!:2:disabled_0:true:<\\:branch_ita\\:921808496767402104>}{button::2:disabled_1:true:<:hacker_ita:920683462229360661>}{button:$getUserVar[data] datas:4:disabled_2:true:<\\:branch_ita\\:921808496767402104>}}]
...
$else
$interactionEdit[;{newEmbed:{description:**๑ ⋆˚₊⋆────ʚ forking code failed ɞ────⋆˚₊⋆ ๑
    ...
    ・<:fork_ita:921808628267237448>・ \`now you have $numberSeparator[$getUserVar[data]] data ๑\`
    ・ —  — ・ˏ͛- <:hacker_ita:920683462229360661> ˎˊ˗・ —  —・**}{color:dabeff}
    };{actionRow:{button:$random[10;950] datas transfered...:2:disabled_0:true:<\\:branch_ita\\:921808496767402104>}{button::2:disabled_1:true:<:hacker_ita:920683462229360661>}{button:$getUserVar[data] datas-:4:disabled_2:true:<\\:branch_ita\\:921808496767402104>}}]
...
$cooldown[1h;{"embeds":"{newEmbed:{description:<a:dp_star6:835142297125519420> *$username, wait __%time%__ secs, there is a traffic on web, uhh it is lagginn !*}{color:dabeff}{thumbnail:$authorAvatar}}", "ephemeral": true, "options":{"interaction" : true}}]
...
$log[— $userTag, used Hack Slash Interaction :3
୨୧・┈┈・┈┈・┈┈・┈┈・┈┈・┈┈・┈┈・┈┈・┈┈・┈┈・┈┈・┈┈・୨୧]`
}