module.exports = [{
  ...
  code:`
    $interactionReply[;{newEmbed:
      {author: Role has been added to role shop!!:$authorAvatar}{thumbnail:$userAvatar[$clientID]}
      {field:slot:<\\:list_ol_ita\\:919866811246334012> $ordinal[$interactionData[options.data[0].options[0].value]]}
      {field:role name & role mention:<\\:at_ita\\:920668357123006485> $interactionData[options.data[0].options[2].value]﹠<@&$interactionData[options.data[0].options[1].value]>} 
      {field:costs: **$numberSeparator[$interactionData[options.data[0].options[3].value]]** <\\:branch_ita\\:921808496767402104> datas}
      {field:description:<\\:questioning_ita\\:919675688620019713> $interactionData[options.data[0].options[4].value]}
...
`
  ...
  $deleteVar[title$interactionData[options.data[0].options[0].value]]
  $wait[1s]
  ...
  $interactionReply[;{newEmbed:
    {author: Role has removed role shop!!:$authorAvatar}
    {thumbnail:$userAvatar[$clientID]}{field:slot:<\\:times_ita\\:920648272144629801> $ordinal[$interactionData[options.data[0].options[0].value]] role removed. . .}
    {color:$getServerVar[hex]}
  }]
