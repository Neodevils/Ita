...
<:dash4:817209877335375932> **Reason**
 $replaceText[$replaceText[$checkCondition[$messageSlice[2]==];true;<:stare:797156847903047810> User has muted due of spamming, emote. Excessive caps, picture or general spam :(];false;$messageSlice[2]]}{color:$getServerVar[hex]}]
 $deletecommand
...
$onlyIf[$message[1]!=;{title:Ummm...}{field:**Can you use it like this? **:\`$getServerVar[prefix]spam <member | userID>\`}{color:$getServerVar[hex]}]
