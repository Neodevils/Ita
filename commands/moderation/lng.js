...
<:dash4:817209877335375932> **Reason**
 $replaceText[$replaceText[$checkCondition[$messageSlice[2]==];true;<:stare:797156847903047810> You should use the server's assigned language, so we can understand and avoid miscommunication :3];false;$messageSlice[2]]}{color:$getServerVar[hex]}]
 $deletecommand
...
$onlyIf[$message[1]!=;{title:Ummm...}{field:**Can you use it like this? **:\`$getServerVar[prefix]lng <member | userID>\`}{color:$getServerVar[hex]}]
