...
<:dash4:817209877335375932> **Reason**
 $replaceText[$replaceText[$checkCondition[$messageSlice[2]==];true;<:stare:797156847903047810> You should take the drama in DMs or Vent channel :3];false;$messageSlice[2]]}{color:$getServerVar[hex]}]
 $deletecommand
...
$onlyIf[$message[1]!=;{title:Ummm...}{field:**Can you use it like this? **:\`$getServerVar[prefix]drama <member | userID>\`}{color:$getServerVar[hex]}]
