module.exports = {
  ...
  code:`
  $title[Administrator role has been updated!]
  $description[*・New admin role settled to \`\`\`$roleName[$mentionedRoles[1]]\`\`\` !*]
  ...
  $setServerVar[admin;$mentionedRoles[1]]
  ...
  $onlyPerms[admin;{description:<a:dp_star6:835142297125519420> Only \`ADMIN\` can set-admin.}{color:$getServerVar[hex]}]
