...
<:dash4:817209877335375932> **Reason**
 $replaceText[$replaceText[$checkCondition[$messageSlice[2]==];true;<:stare:797156847903047810> Thanks for helping to the member but take a break a few minutes for doing staffs' job :3];false;$messageSlice[2]]}{color:$getServerVar[hex]}]
 $deletecommand
...
$onlyIf[$message[1]!=;{title:Ummm...}{field:**Can you use it like this? **:\`$getServerVar[prefix]minimod <member | userID>\`}{color:$getServerVar[hex]}]
