...
type: 'interaction', 
prototype: 'slash', 
code: `$interactionReply[;{newEmbed:{title:Truth or Dare :3?}{description:$randomText[Hewwo;Hiii;Hellooo] *!* You got two options to pick. . . 

<\\:truth_ita\\:937976586735595530> **truth**
***o__r__***
<\\:dare_ita\\:937976651130732605> **dare**}{color:$getServerVar[hex]}{footer:pick $randomText[truth;dare] 👀}{thumbnail:$userAvatar[$clientID]}};{actionRow:{selectMenu:tod:🧋 truth or dare. . . :1:1:no:{selectMenuOptions:๑ truth:0:humm... no lies okay?:false:<:truth_ita:937976586735595530>}{selectMenuOptions:๑ dare:1:if you dare hhh:false:<:dare_ita:937976651130732605>}]
